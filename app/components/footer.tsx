...
export default function Footer() {
    return <footer className={`${inter.className} fixed left-0 bottom-0 px-[4vw] py-[4vh] bg-zinc-900 bg-opacity-50 text-gray-50 w-screen h-fit text-center xl:h-fit`}>
